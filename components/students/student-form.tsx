...
export function StudentForm({ centers, initialData }: StudentFormProps) {
  ...
  // Generate day, month, year arrays for DOB
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl>
                      <Textarea placeholder="Street, Building, Area" rows={3} {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" step="0.01" placeholder="75.5" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
